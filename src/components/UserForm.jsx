...
const UserForm = () => {
    const [userData, setUserData] = useState({
        ...
        function resultado(){
            ...
            //Precio M2
            const precioM2 = userData.m2 * 40.55;
            //Sacar edad
            ...
            <div className="bg-slate-200 p-8 rounded">
                ...
                <div className="p-2">
                    ...
                    <select name="" id="tipoPropiedad" onChange={handleTipoPropiedad} className="text-start text-xl w-full" required>
                        <option value="">-- Seleccione Tipo Propiedad --</option>
                        {displayData}
                    </select>
                </div>

                <div className="p-2">
                    <label htmlFor="" className="flex font-semibold text-xl p-2">Ubicacion</label>
                ...
                <div className="p-2">
                    <label htmlFor="" className="flex font-semibold text-xl p-2">Ingresar Año de Construccion:</label>
                ...
                <div className="flex flex-col items-center justify-center p-8 w-full">
                    <div className="flex items-center justify-center">
                        <button id="btnForm" type="submit" className="text-center text-xl mt-4 p-2 bg-slate-300 hover:bg-green-500 text-black hover:text-white rounded-xl">Cotizar</button>
                    </div>
                </div>

                <div className="flex flex-row items-center justify-center p-8 w-full">
                    <p className='text-black text-2xl font-semibold text-center p-2'>Precio Estimado: $</p>
                    <p id='resume' className='text-black text-2xl font-bold text-center'> 0,00 </p> 
                </div>
