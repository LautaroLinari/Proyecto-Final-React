    ...
    <div className="">
        ...
        <div className="grid lg:flex items-center justify-center p-12 lg:gap-10 bg-slate-200 dark:bg-neutral-800">
            ...
            <div className=" p-8 border rounded border-white bg-white dark:bg-neutral-800 text-black dark:text-white shadow-2xl hover:border-neutral-600">
                ...
                <DivCobertura image="../../../proyecto-final/src/assets/icons/house-fire.png" text="Contra incendios:" valor="$750"/>
                <DivCobertura image="../../../proyecto-final/src/assets/icons/stolen-house.png" text="Robos en su hogar:" valor="$750"/>
                <DivCobertura image="../../../proyecto-final/src/assets/icons/damaged-house.png" text="Daños en su hogar:" valor="$500"/>
                <div className="pt-6">
            ...
            <div className=" mt-10 border border-white rounded p-8 bg-white dark:bg-neutral-800 dark:text-white shadow-2xl hover:border-neutral-600">
                ...
                <DivCobertura image="../../../proyecto-final/src/assets/icons/stolen-house.png" text="Robos en su hogar:" valor="$750"/>
                <DivCobertura image="../../../proyecto-final/src/assets/icons/damaged-house.png" text="Daños en su hogar:" valor="$500"/>
                <DivCobertura image="../../../proyecto-final/src/assets/icons/appliance.png" text="Reposición Electrodomesticos:" valor="$750"/>
                <DivCobertura image="../../../proyecto-final/src/assets/icons/civil.png" text="Responsabilidad Civil:" valor="$400"/>
                <DivCobertura image="../../../proyecto-final/src/assets/icons/glasses.png" text="Cristales:" valor="$350"/>
                <div className="pt-6">
