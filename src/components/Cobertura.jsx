...
function Cobertura() {
  return (
    <div className="">
        <h3 className="text-xl lg:text-2xl font-bold tracking-wide text-cyan-600 dark:text-cyan-500 text-center bg-slate-200 dark:bg-neutral-800 w-auto underline pt-5">Opciones de seguro de Cobertura:</h3>
        <div className="grid lg:flex items-center justify-center p-12 lg:gap-10 bg-slate-200 dark:bg-neutral-800">
            ...
            <div className="mt-8 border border-white rounded p-8 bg-white dark:bg-neutral-800 dark:text-white shadow-2xl hover:border-neutral-600">
                ...
                <div className="pt-6">
                    <h2 className="text-xl md:text-2xl text-white font-bold p-2 bg-green-700 rounded pointer"> Precio Total: $3000</h2>
                </div>
            </div>  
